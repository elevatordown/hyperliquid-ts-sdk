...
class Exchange extends api_1.API {
    ...
    async bulkOrders(orderRequests) {
        ...
        const grouping = 'na';
        const signature = await (0, signing_1.signL1Action)(this.wallet, ['(uint32,bool,uint64,uint64,bool,uint8,uint64)[]', 'uint8'], [
            orderSpecs.map((os) => (0, signing_1.orderSpecPreprocessing)(os)),
            (0, signing_1.orderGroupToNumber)(grouping),
        ], this.vaultAddress === undefined ? signing_1.ZERO_ADDRESS : this.vaultAddress, timestamp);
